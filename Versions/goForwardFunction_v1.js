class Node {
  ...
  function userDefinedList(){
    ...
    inputBox.position(userDefinedButton.x, height - 175);
    // inputBox.input(addToList);
  
    submitButton = createButton('Submit');
    submitButton.position(inputBox.x + inputBox.width + 10, height - 175);
