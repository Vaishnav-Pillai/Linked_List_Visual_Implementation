class Node {
  ...
  function setup() {
    ...
    userDefinedButton.position(emptyButton.x + emptyButton.width + 100, createListButton.y);
    ...
    randomButton.position(userDefinedButton.x + userDefinedButton.width + 75, createListButton.y);
    randomButton.class('customButton');
    randomButton.hide();
    randomButton.mouseClicked(randomList);
  
    randomSortedButton = createButton('Random Sorted List');
    randomSortedButton.position(randomButton.x + randomButton.width + 63, createListButton.y);
    ...
    insertTailButton.position(insertHeadButton.x + insertHeadButton.width + 68, insertButton.y);
    ...
    insertAnyButton.position(insertTailButton.x + insertTailButton.width + 81, insertButton.y);
    ...
    removeTailButton.position(removeHeadButton.x + removeHeadButton.width + 52, removeButton.y);
    ...
    removeAnyButton.position(removeTailButton.x + removeTailButton.width + 64, removeButton.y);
    ...
    progressBarX = removeAnyButton.x + removeAnyButton.width + 10;
  
    progressBarY = removeAnyButton.y;
  ...
  function playAnimation() {
    ...
    forwardButton.attribute('disabled', true);
    if(fwdFlag===true){
      setTimeout(pauseAnimation,1800);
      fwdFlag=false;
    }
  }
  ...
  function updateProgressBar(progress){
    strokeWeight(2);
    fill(112, 100, 50, 50);
    rect(progressBarX, progressBarY, 180 * (progress/100), 20, 5, 5, 5, 5);
    fill(0);
    textAlign(CENTER, CENTER);
    textSize(12);
    text(parseInt(progress) + '%', progressBarX + 180 / 2, progressBarY + 20 / 2);
  }
  
  function createProgressBar() {
    fill(350,0,42);
    rect(progressBarX, progressBarY, 180, 20, 5, 5, 5, 5);
  }
